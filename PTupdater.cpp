...
bool checkUpdates() {
	string vcheckurl = "https://piotr-trybisz.000webhostapp.com/!vlo/update/lastVersion.txt";
	string newVersion = exec("powershell (New-Object System.Net.WebClient).DownloadString('https://piotr-trybisz.000webhostapp.com/!vlo/update/lastVersion.txt')");
